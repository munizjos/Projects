...
In this project, we will be narrowing down the mechanical properties of materials by finding ones that will most likely be used for long-term strength and durability. We will examine top choices for stiff and flexible materials as well. The data itself was obtained from the AutoDesk Material Library. This data set includes data of 1553 different materials, some materials may be labeled as the same (e.g, steel) but have different carbon content and are therefore different (e.g, Steel SAE 1020).
...
Given the dataset, I will examine the strength, durability, and compatibility of materials by examining their tensile strength, their yield strength, and elastic modulus. The data will be filtered to meet the demands for hypothetical industrial thresholds, including materials that may require high stiffness or high flexibility.

In terms of high stiffness, I predict that steel will be the top contender for strength and durability, specifically by achieving an ultimate tensile strength of 700 MPa or higher. In terms of flexibility, I predict aluminum to be a top contender for strength-to-weight ratio and flexibility for industry deployment. Specifically, I expect aluminum to be about 200 MPa in terms of tensile strength.
...
*(1) Ultimate Tensile Strength of All Materials*

To first understand the strength distribution for all provided materials, a scatter plot was created measuring the ultimate tensile strength for all materials. This plot will eventually be filtered to accommodate other mechanical properties that an engineer may look at when choosing ideal materials to implement in a heavy-duty industrial setting.
...
*(1b) Top Material Choices for High Ultimate Tensile Strength*
...
*(2) Top Material Choices for High Ultimate Tensile Strength and Yield Strength*
...
In general, yield strength can be defined as the stress needed for a material to begin plastic deformation (i.e., permanent deformation).
...
*(3) Top Material Choices for Strong & Stiff Material*

Realistically, an engineer would want a good blend of material properties. In the case of the need for stiff and strong materials, an engineer may opt for materials that may exhibit high ultimate tensile strength, high yield strength, and medium to high elastic modulus.
...
Noted from the scatter plot, one of the general materials that would offer a good blend of mechanical properties for strong yet stiff materials would be steel. Specifically, they would be alloy steels with different grades/specifications, heat treatments methods, and alloying compositions (e.g, different carbon content).

### Diving Deeper

Exploring the relationships and trade-offs between the materials and their mechanical properties.

*(I) High Strength vs Ductility*

How much ductility (elongation) can you get in a given material while maintaining a strong foundation of strength (i.e., high UTS)?
...
strength_elongation_plot <- ggplot (
  ...
  geom_point() +
  labs (
    title = "Relationship Between Material's Strength & Ductility",
...
*(II) Strength vs Stiffness*

How stiff should a material be while trying to maintain the strength of the given material?
...
*(III) Top Material Choices for High Strength and Low Stiffness (High Flexibility)*
...
As demonstrated from the scatter plot, aluminum is shown to be one of the top choices for materials that are strong yet flexible for industrial use.

## Discussion

Based on the results, my previously claimed hypothesis was supported. We found that, in terms of finding materials well-suited for heavy-duty industrial applications, there are three large sectors to be considered. This includes the amount of strength, flexibility, and/or stiffness one may require for a specific use. In terms of finding materials that are well-made for exhibiting high strength and stiffness, we found steel to be a top choice. In terms of finding materials with high strength and low stiffness (high flexibility), we found aluminum to be a top choice.

In regard to the results updating my current beliefs, I find that there are plenty of other factors that one should consider when trying to find the right material for specific industrial use. For instance, this data only provided information about mechanical properties, but for industrial use, chemical properties like thermal and corrosion resistance should also be considered.
